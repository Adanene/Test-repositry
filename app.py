...
if jumlah_beban == "4" :
        ...
        bebanE = 0
        bebanF = 0
        Jbeban = st.number_input("Weight Distance from midship (m)" ,min_value= 0.00, max_value= halfBreadth , step =0.01)
...
if ok:
    ...
    train_data, test_data = train_test_split(data, test_size=0.25, random_state=85)
