...
if ok:
    ...
    train_data, test_data = train_test_split(data, test_size=0.25, random_state=80)
    ...
    xgboost_model = xgb.XGBRegressor(random_state=575, objective="reg:squarederror")  # Note: objective is set to handle regression tasks
