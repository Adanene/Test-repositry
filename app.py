...
#make the interface
st.title("Ship inclining prediction Ver 1.7 (XGB)")
st.write("""### How to use: """)
...
if ok:
    ...
    train_data, test_data = train_test_split(data, test_size=0.3, random_state=85)
    ...
    param_grid = {
        ...
        'alpha': [0.1, 1, 10],  # L1 regularization (you can adjust the list as needed)
        'lambda': [0.1, 1, 10],  # L2 regularization (adjust as needed)
        'gamma': [0, 0.1, 0.5, 1]  # Regularization for tree splitting (adjust as needed)
    }
...
if ok:
    ...
    # Split the dataset into training and test sets
    train_data, test_data = train_test_split(data, test_size=0.25, random_state=700)
    ...
    # Create the XGBoost regressor
    xgboost_model = xgb.XGBRegressor(random_state=800, objective="reg:squarederror")  # Note: objective is set to handle regression tasks
...
if st.session_state.button_pressed:
        if jumlah_beban =="0" :
                ...
                Mratio1 = (Mselisih1 / totalB) * 100
                Mratio2 = (Mselisih2 / totalB) * 100
                Mratio3 = (Mselisih3 / totalB) * 100
                Mratio4 = (Mselisih4 / totalB) * 100
                Mratio5 = (Mselisih5 / totalB) * 100
                Mratio6 = (Mselisih6 / totalB) * 100
                Mratio7 = (Mselisih7 / totalB) * 100
                Mratio8 = (Mselisih8 / totalB) * 100
